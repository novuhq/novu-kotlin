...
class OrganizationsApiTest {
    ...
    @Test
    fun testUpdateOrganizationName() =
        runTest {
            val responseBody =
                ResponseWrapper(
                    data =
    ...
    @Test
    fun testFetchCurrentOrganization() =
        runTest {
            val responseBody =
                ResponseWrapper(
                    data =
    ...
    @Test
    fun testFetchMembersOfOrganization() =
        runTest {
            val responseBody =
                ResponseWrapper(
                    data =
    ...
    @Test
    fun testUpdateOrganizationBrand() =
        runTest {
            val responseBody =
                ResponseWrapper(
                    data =
